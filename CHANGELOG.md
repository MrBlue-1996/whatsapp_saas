...
## [0.9.0](https://github.com/danielgonzagat/whatsapp_saas/compare/v0.8.0...v0.9.0) (2026-05-29)


### Features

* **kloel:** preserve response engine recovery delta ([9049b5a](https://github.com/danielgonzagat/whatsapp_saas/commit/9049b5a7cefcbfd3325efa1925c860248fc7843a))
* **kloel:** publish accumulated cognitive commerce work ([dfc9fe1](https://github.com/danielgonzagat/whatsapp_saas/commit/dfc9fe1d9e973bf60fb80e9b91f35c4d163c4541))
* **marketing:** preserve complete scope integration delta ([53607b3](https://github.com/danielgonzagat/whatsapp_saas/commit/53607b3115d1bc4169b51dff4de159c8d7314e69))
* **omnicore:** wave w1 — 6 channeldispatchadapters under marketing/channels ([7afb72f](https://github.com/danielgonzagat/whatsapp_saas/commit/7afb72fd6880ebfef6a73aa97d71c3002525f08a))
* **omnicore:** wave w2 — wire channeldispatchregistry with 6 adapters via di ([7fff828](https://github.com/danielgonzagat/whatsapp_saas/commit/7fff8288d6e30287302c1ceba9fb0e3e30c01b68))
* **omnicore:** wire marketingchannelsmodule into appmodule + stub-route audit doc ([1fcd908](https://github.com/danielgonzagat/whatsapp_saas/commit/1fcd908bfb453bd90138d3a285b6aeb4dc2aedd6))
* **ops:** canonical vocabulary + services anti-regression gates ([b86405a](https://github.com/danielgonzagat/whatsapp_saas/commit/b86405ad9814345d3cbdc42f20be65d56863b4e2))
* **ops:** gate g4 — mind canonical imports + migrate last 2 admin callers ([e663406](https://github.com/danielgonzagat/whatsapp_saas/commit/e663406938c1130e6e6f97fe13642625843b67f0))
* **pulse:** preserve liquefaction source delta ([187fa54](https://github.com/danielgonzagat/whatsapp_saas/commit/187fa54e633977893a662ebeb2bd3ee96ba99ed0))
* **self-awareness:** cognitive bridge for KLOEL chat (Wave 7 PI-CC) ([3ac340b](https://github.com/danielgonzagat/whatsapp_saas/commit/3ac340b9c36536ce09233051daac19b920f28aa5))
* **self-awareness:** deps-coverage tools for KLOEL chat (Wave 7 PI-EE) ([6569dda](https://github.com/danielgonzagat/whatsapp_saas/commit/6569dda73dc07b4e9dab9a20d6f3712cb669f482))
* **self-awareness:** pulse-runtime tools for KLOEL chat (Wave 7 PI-DD) ([98151c1](https://github.com/danielgonzagat/whatsapp_saas/commit/98151c130372e0a87de7e59a85a5a4f30b4917d1))
* **sites:** build Sites backend module from scratch (Wave 8 PI-FF) ([faaaa6e](https://github.com/danielgonzagat/whatsapp_saas/commit/faaaa6ea93213610ee0bffde5743772c63e268ab))
* **sites:** wire frontend end-to-end to Sites backend (Wave 10 PI-LL) ([9313fd1](https://github.com/danielgonzagat/whatsapp_saas/commit/9313fd1ba9c0defe9594b301e9012bd599572075))
* **stub-detector:** wire /sales to VendasView + reduce detector false positives 59→22 ([8e6a2e3](https://github.com/danielgonzagat/whatsapp_saas/commit/8e6a2e3da98634861fe653d851f8613697005cf6))
* **worker:** dlq wiring for 5 queues (wave 9 pi-jj) ([b20584c](https://github.com/danielgonzagat/whatsapp_saas/commit/b20584c3305a3c5a28de693f31de6fd69605eed2))
* **worker:** mass-send consumer + DLQ + idempotency (Wave 9 PI-II) ([693eccc](https://github.com/danielgonzagat/whatsapp_saas/commit/693eccca440bdef802b9b6ffe201de802e07b937))


### Bug Fixes

* **api:** cross-tab refresh stomp + 429 backoff + differentiated recovery per backend error code ([6bf2c96](https://github.com/danielgonzagat/whatsapp_saas/commit/6bf2c968d98be3430cae7c3f148b6bdc173070bf))
* **auth:** wrap refresh token claim + issue in single transaction with differentiated error codes ([33f1527](https://github.com/danielgonzagat/whatsapp_saas/commit/33f1527c48c76d916b31592f4c640dd91c4a8f0d))
* **backend:** eliminate 17 pre-existing TS errors after exactOptionalPropertyTypes activation ([acf2679](https://github.com/danielgonzagat/whatsapp_saas/commit/acf2679978388392a4c2d0342c720a3b733ee677))
* **backend:** keep landing recovery gates compliant ([b106088](https://github.com/danielgonzagat/whatsapp_saas/commit/b1060886b1c96bd2f007a949414d9eb64ee82ba2))
* **backend:** restore backend gate compliance ([6ceca77](https://github.com/danielgonzagat/whatsapp_saas/commit/6ceca778f1fb1c05f1504948241f808b2df0034a))
* **backend:** satisfy backlog typecheck gate ([623e3f5](https://github.com/danielgonzagat/whatsapp_saas/commit/623e3f54d9fc18d4495e4baf77758f0bf80f0898))
* **backend:** satisfy smoke and lint gates ([0966938](https://github.com/danielgonzagat/whatsapp_saas/commit/0966938be7bea203e6c203007f6b50384a69f6ba))
* **backend:** stabilize public landing gates ([7749a04](https://github.com/danielgonzagat/whatsapp_saas/commit/7749a0411464b0e51f0fc54a05770af9cd48ce39))
* **backend:** use bullmq redis connection options ([b8425b8](https://github.com/danielgonzagat/whatsapp_saas/commit/b8425b8b753c74ec465ae406f06e170f202ed08c))
* **backend:** wave h — eslint curly autofix (1034 → 0 violations) ([7252345](https://github.com/danielgonzagat/whatsapp_saas/commit/72523454410194bbc70d6ac4490293a443d33a3e))
* **billing:** node-s regression guard — deeper stripe interop probe + spec ([19fbe8d](https://github.com/danielgonzagat/whatsapp_saas/commit/19fbe8d03d15d7e7415adc6d096b0581fe80ada9))
* **billing:** pin STRIPE_API_VERSION to SDK republished value (unblocks prod deploy) ([cc974a8](https://github.com/danielgonzagat/whatsapp_saas/commit/cc974a887d040667a41541e9b866f7918fc978bb))
* **billing:** pin STRIPE_API_VERSION to the SDK's republished value ([3bcd02c](https://github.com/danielgonzagat/whatsapp_saas/commit/3bcd02c0bc9d8fd5ae3e1526febcba0c139023d1))
* **ci:** clear PR 448 eslint seatbelt regressions ([fa2e7d8](https://github.com/danielgonzagat/whatsapp_saas/commit/fa2e7d816351fe5f9a91b847419b1c9f834268d8))
* **ci:** expose tenant filters in list queries ([200e573](https://github.com/danielgonzagat/whatsapp_saas/commit/200e573285ebd7d56ab4110c3ec8af0be75a9dc4))
* **ci:** remove product json double casts ([134a0c7](https://github.com/danielgonzagat/whatsapp_saas/commit/134a0c7373c26f02a35255c9aed3399216ae3c20))
* **ci:** satisfy architecture diff guard ([97f3a5a](https://github.com/danielgonzagat/whatsapp_saas/commit/97f3a5a87a77229e164cab91ed41f2437a53956f))
* **ci:** scope self-awareness runtime cache key ([cbe8675](https://github.com/danielgonzagat/whatsapp_saas/commit/cbe86756256a004a62b4c5b09b368984c8167fd9))
* **ci:** stabilize PR 448 consolidation gates ([8397a12](https://github.com/danielgonzagat/whatsapp_saas/commit/8397a12787d633862ed4c3760b366de72b57b0d0))
* **ci:** sync worker prisma schema ([0e95c3f](https://github.com/danielgonzagat/whatsapp_saas/commit/0e95c3f493afe2b48d4ef68146b966bd2a05bfac))
* **deps-coverage:** exactOptionalPropertyTypes + array-undefined narrows (Wave 7 follow-up) ([b2ebeea](https://github.com/danielgonzagat/whatsapp_saas/commit/b2ebeea182f6e01d9386d19c87b8909611316df0))
* **frontend:** drop 5 ESLint errors (privacy + dashboard hooks) ([813ab7a](https://github.com/danielgonzagat/whatsapp_saas/commit/813ab7aa40b337e009e25e1d3819dd5f8c8a472a))
* **frontend:** preserve onboarding cta focus state ([ed0c064](https://github.com/danielgonzagat/whatsapp_saas/commit/ed0c064686858294dfc3731aea7d6f59be10bf62))
* **frontend:** prevent Kloel chat router hijacks ([2211ed1](https://github.com/danielgonzagat/whatsapp_saas/commit/2211ed1624459bc4c0ce77b76da4715a2a8a71c0))
* **frontend:** restore onboarding step trace color ([8c5e2de](https://github.com/danielgonzagat/whatsapp_saas/commit/8c5e2de26df60fdcbbfe2b9a9032fbb5ed1666b9))
* **frontend:** restore public landing page ([afa49ab](https://github.com/danielgonzagat/whatsapp_saas/commit/afa49ab3ac40815db7a0eb119e42914aeb245c9d))
* **frontend:** restore public landing page ([2c67cb4](https://github.com/danielgonzagat/whatsapp_saas/commit/2c67cb4d7313ac8563b02e2a91095e546fac6c92))
* **frontend:** satisfy API test lint gate ([1d6c6c0](https://github.com/danielgonzagat/whatsapp_saas/commit/1d6c6c0a6c530b18efc3e829c4caa30806a9aaee))
* **frontend:** satisfy onboarding visual contract ([518338f](https://github.com/danielgonzagat/whatsapp_saas/commit/518338fb9a8792915dec3552e61ae76d4d0593ac))
* **frontend:** stabilize dashboard home swr options ([83de504](https://github.com/danielgonzagat/whatsapp_saas/commit/83de5044d88c91ff8a6d5ac54334347281b1ebd6))
* **kloel-chat-tools:** pass productService to runUpdateProduct in toolUpdateProduct ([20f6256](https://github.com/danielgonzagat/whatsapp_saas/commit/20f62566ccb7502eb69ff56790c7a3f8b858d45e))
* **kloel-chat-tools:** use conditional-spread in toolSaveProduct for exactOptionalPropertyTypes ([dbef087](https://github.com/danielgonzagat/whatsapp_saas/commit/dbef087e2c3cf9719430f5f73ae1a8063ca1048b))
* **kloel:** expose self awareness intents ([4fcf5a6](https://github.com/danielgonzagat/whatsapp_saas/commit/4fcf5a6581681ef2b1b3a363f1b8c633ec3f9165))
* **kloel:** preserve local landing recovery commits ([1f4d087](https://github.com/danielgonzagat/whatsapp_saas/commit/1f4d0871a7eeb901c4b4e6e84b1ce4160443768f))
* **kloel:** preserve local public layout recovery commit ([6e0fe83](https://github.com/danielgonzagat/whatsapp_saas/commit/6e0fe83c0b9fe610c4bc4c6efdffe65d61b5a5f1))
* **kloel:** route sse actions before llm ([cd2b7c3](https://github.com/danielgonzagat/whatsapp_saas/commit/cd2b7c35f10d833b60905f582852ef1dd68fc0f5))
* **kloel:** route text llm by configured provider ([fa3fafa](https://github.com/danielgonzagat/whatsapp_saas/commit/fa3fafa99536c10ba23bea4ff1b9a3c766c36d87))
* **kloel:** route text llm by configured provider ([42212d3](https://github.com/danielgonzagat/whatsapp_saas/commit/42212d3d585dc124096cfd9a01b251f7f9945072))
* **kloel:** stabilize dispatcher and backend boot ([fc137c7](https://github.com/danielgonzagat/whatsapp_saas/commit/fc137c7e0434f9b3f008bcccaa0c760fcb5484bf))
* **kloel:** wire cognitive state into chat stream ([acfe921](https://github.com/danielgonzagat/whatsapp_saas/commit/acfe921378d796e2c840e2965e3b8718dc1443d8))
* **lint:** satisfy backlog pre-push gate ([b51d0c5](https://github.com/danielgonzagat/whatsapp_saas/commit/b51d0c54b261bf7980bf1f7479a5ae4149a5e208))
* **lint:** satisfy changed-code gate for backlog branch ([19f4437](https://github.com/danielgonzagat/whatsapp_saas/commit/19f44372cbb4ca8a4c70f84fe8b699baf5cc3c2d))
* **marketing:** center channel selector in app rail ([fac2ca2](https://github.com/danielgonzagat/whatsapp_saas/commit/fac2ca25fee4e6b633970c1ae85865643deeecb4))
* **marketing:** simplify sidebar chrome ([8e5f93e](https://github.com/danielgonzagat/whatsapp_saas/commit/8e5f93e24b5392be7accabd17bfb0983ea2669c9))
* **omnicore:** channels dispatch — use exported services + module deps ([4f29434](https://github.com/danielgonzagat/whatsapp_saas/commit/4f29434ffc7c936ba1603a7e29d8f01d9af78193))
* **omnicore:** correct 6 stale imports in whatsapp/* after helpers move ([3911f2d](https://github.com/danielgonzagat/whatsapp_saas/commit/3911f2d9fdf1bcd6d0392cfe73b9efd500eea5d8))
* **omnicore:** correct imports in moved whatsapp-watchdog.helpers ([94b3f1b](https://github.com/danielgonzagat/whatsapp_saas/commit/94b3f1b9b405fcd0fd715a23d5dcf799aab77d1b))
* **omnicore:** correct stale import in whatsapp-normalization.util.ts ([13bcabc](https://github.com/danielgonzagat/whatsapp_saas/commit/13bcabce6e8fb17e7aea9a7dc8f02c59f3d30211))
* **onboarding-chat:** harden safeRandomUUID with getRandomValues fallback ([6cf1253](https://github.com/danielgonzagat/whatsapp_saas/commit/6cf1253d558e2ad62d752122164f4bacf0c4c6ce))
* **ops:** unblock ai-constitution — strip banned tokens from gates + jsdoc ([b21508a](https://github.com/danielgonzagat/whatsapp_saas/commit/b21508a739f5228b6a32ddcc7a98adb290b3599f))
* **pulse:** stabilize runtime source root detection ([249e1c9](https://github.com/danielgonzagat/whatsapp_saas/commit/249e1c971c6f5a38caf1df0573fbb998022c0c40))
* **security:** eliminate 2 ReDoS vulnerabilities in Meta OAuth helpers ([e46b2e8](https://github.com/danielgonzagat/whatsapp_saas/commit/e46b2e8807e93ba6ba29144269aa75de6b64e7a6))
* **settings:** preserve provider settings wave delta ([806f1fe](https://github.com/danielgonzagat/whatsapp_saas/commit/806f1fe3b542bbdc206f9cd84ec49260019fc4cb))
* **stub-detector:** broaden delegate-to-component pattern (any PascalCase from @/components/) ([88c08df](https://github.com/danielgonzagat/whatsapp_saas/commit/88c08df0eb05aaf1e42ed7620ac71c3e8555fb3e))
* **tenant:** preserve tenant resolver wave delta ([3b22fd5](https://github.com/danielgonzagat/whatsapp_saas/commit/3b22fd5dc15d363cb9249e7cc2ab5ee6311c1e03))
* **test:** align AuthRefreshResponseSchema contract spec with PI-μ refresh_token=required change ([d2699dc](https://github.com/danielgonzagat/whatsapp_saas/commit/d2699dc14328a52931d2076844c62c53c0b1f418))
* **visual:** refresh Linux landing baselines ([f23cad9](https://github.com/danielgonzagat/whatsapp_saas/commit/f23cad99c70b162cb08a958efb58bd3819ae3d0b))
* **whatsapp:** preserve phone normalization wave delta ([649fd96](https://github.com/danielgonzagat/whatsapp_saas/commit/649fd96d13589e9679e8b2dda6ae0956fc8c7fa2))
* **worker:** clear pre-push lint blockers ([1259f42](https://github.com/danielgonzagat/whatsapp_saas/commit/1259f427618a53db1b8c0ec2491afc1ad495d6fe))
* **worker:** preserve pr266 self-improvement delta ([cd49243](https://github.com/danielgonzagat/whatsapp_saas/commit/cd49243a9da7e5daf2fc03e88bb20b8c163d6ab5))
* **worker:** remove campaign-jobs dual consumer + delete 2 dead workers (Wave 9 PI-KK) ([73df6ff](https://github.com/danielgonzagat/whatsapp_saas/commit/73df6fff58f33fc52260dd169bcaeb5435b29fae))


### Reverts

* **lint:** remove broad formatting cleanup ([871371f](https://github.com/danielgonzagat/whatsapp_saas/commit/871371fbfd47e0e435f06113e7d9c527fd190ff4))
